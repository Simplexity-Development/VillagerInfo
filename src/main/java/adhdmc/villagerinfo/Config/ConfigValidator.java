...
public class ConfigValidator {
    ...
    private static void loadToggleMap() {
        ...
        FileConfiguration config = VillagerInfo.plugin.getConfig();
        toggleSettings.put(ToggleSetting.PROFESSION, config.getBoolean("profession", true));
        toggleSettings.put(ToggleSetting.JOB_SITE, config.getBoolean("job-site", true));
        toggleSettings.put(ToggleSetting.LAST_WORKED, config.getBoolean("last-worked", true));
        toggleSettings.put(ToggleSetting.BED_LOCATION, config.getBoolean("bed-location", true));
        toggleSettings.put(ToggleSetting.LAST_SLEPT, config.getBoolean("last-slept", true));
        toggleSettings.put(ToggleSetting.INVENTORY, config.getBoolean("inventory", true));
        toggleSettings.put(ToggleSetting.RESTOCKS, config.getBoolean("restocks", true));
        toggleSettings.put(ToggleSetting.REPUTATION, config.getBoolean("reputation", true));
        toggleSettings.put(ToggleSetting.HIGHLIGHT_WORKSTATION, config.getBoolean("highlight-workstation", true));
        toggleSettings.put(ToggleSetting.SOUND_TOGGLE, config.getBoolean("sound-toggle", true));
    }
